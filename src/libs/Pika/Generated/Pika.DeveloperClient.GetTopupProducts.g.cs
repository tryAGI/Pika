...
namespace Pika
{
    public partial class DeveloperClient
    {
        ...
        private static readonly global::Pika.EndPointSecurityRequirement[] s_GetTopupProductsSecurityRequirements =
            new global::Pika.EndPointSecurityRequirement[]
            {                s_GetTopupProductsSecurityRequirement0,
            };
        partial void PrepareGetTopupProductsArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareGetTopupProductsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessGetTopupProductsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetTopupProductsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Pika.TopupProductsResponse> GetTopupProductsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Pika.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetTopupProductsSecurityRequirements,
                operationName: "GetTopupProductsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetTopupProductsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Pika.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Pika.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetTopupProducts",
                                methodName: "GetTopupProductsAsync",
                                pathTemplate: "\"/developer/topup/products\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetTopupProductsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Pika.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetTopupProductsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
