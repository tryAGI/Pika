...
namespace Pika
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Pika.AutoSDKRetryOptions Retry { get; set; } = new global::Pika.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Pika.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Pika.IAutoSDKHook>();
        ...
        public global::Pika.AutoSDKClientOptions AddHook(
            global::Pika.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Pika.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Pika.AutoSDKClientOptions UseAuthorizationProvider(
            global::Pika.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Pika.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Pika.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Pika.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Pika.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Pika.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Pika.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Pika.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Pika.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Pika.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Pika.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Pika.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Pika.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Pika.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Pika.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Pika.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Pika.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Pika.AutoSDKClientOptions clientOptions,
            global::Pika.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Pika.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Pika.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Pika.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Pika.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Pika.IAutoSDKHook, global::Pika.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Pika.AutoSDKHookContext context)
        {
