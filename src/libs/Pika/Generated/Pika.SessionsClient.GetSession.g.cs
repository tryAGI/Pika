...
namespace Pika
{
    public partial class SessionsClient
    {
        ...
        private static readonly global::Pika.AutoSDKServer[] s_GetSessionServers = new global::Pika.AutoSDKServer[]
        ...
        private static readonly global::Pika.EndPointSecurityRequirement s_GetSessionSecurityRequirement0 =
        ...
        private static readonly global::Pika.EndPointSecurityRequirement[] s_GetSessionSecurityRequirements =
            new global::Pika.EndPointSecurityRequirement[]
            {                s_GetSessionSecurityRequirement0,
            };
        partial void PrepareGetSessionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sessionId);
        partial void PrepareGetSessionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string sessionId);
        partial void ProcessGetSessionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetSessionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Pika.SessionStatusResponse> GetSessionAsync(
            string sessionId,
            global::Pika.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetSessionAsResponseAsync(
                sessionId: sessionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Pika.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Pika.AutoSDKHttpResponse<global::Pika.SessionStatusResponse>> GetSessionAsResponseAsync(
            string sessionId,
            global::Pika.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Pika.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetSessionSecurityRequirements,
                operationName: "GetSessionAsync");
                ...
                else
                {
                    await global::Pika.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetSessionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Pika.SessionStatusResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Pika.AutoSDKHttpResponse<global::Pika.SessionStatusResponse>(
                                ...
                                {
                                    throw global::Pika.ApiException.Create(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Pika.SessionStatusResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
